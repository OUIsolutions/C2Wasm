...
[![Version](https://img.shields.io/badge/version-0.8.0-blue.svg)](https://github.com/OUIsolutions/C2Wasm/releases/tag/0.8.0)
...
Download the latest version of [c2wasm.c](https://github.com/OUIsolutions/C2Wasm/releases/download/0.8.0/c2wasm.c) and save it in your project directory.
...
| [AI Doc](docs/aidoc.md) | Use this file if you need to make prompts that utilize this library |
